...
// ready.js
$(document).ready(function(){scrollToAnchor();selectOnScroll();loadPhotos();loadYear()});function scrollToAnchor(){$('a[href^="#"]').each(function(){var a=$(this).attr("href");$(this).click(function(b){b.preventDefault();$("html,body").animate({scrollTop:$(a).offset().top+1},"slow")})})}
...
function loadPhotos(){$("#bridge .section-photos .display-image").gallery({source:"#bridge .section-photos img",selectClass:"shown",showCaptions:!0,captionTarget:"#bridge .section-photos .image-caption",waitTime:7E3})}function loadYear(){var a=new Date;$(".year").text(a.getFullYear())};