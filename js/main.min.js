...
function setupButtons(){$(".donate-button").click(function(){window.open("https://support.ewb-usa.org/cuewb","_blank")})}function loadYear(){var a=new Date;$(".year").text(a.getFullYear())};
