...
function loadPhotos(){$("#bridge .section-photos .display-image").gallery({source:"#bridge .section-photos img",selectClass:"shown",showCaptions:!0,captionTarget:"#bridge .section-photos .image-caption",waitTime:7E3})}function setupButtons(){$(".donate-button").click(function(){window.open("https://ssl.charityweb.net/ewbusa/?Custom3=100016","_blank")})}function loadYear(){var a=new Date;$(".year").text(a.getFullYear())};